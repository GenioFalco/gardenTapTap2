      ...
      <div className="flex-1 overflow-y-auto relative z-10">
        <div className="flex flex-col items-center space-y-3">
          ...
          <motion.div 
            ...
            className="w-full max-w-md bg-gray-900/70 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden"
          >
            <div className="p-3">
          ...
          {/* Блок рейтинга с фиксированной высотой и внутренней прокруткой */}
          <div className="w-full max-w-md bg-gray-800/60 backdrop-blur-sm rounded-lg shadow-xl overflow-hidden">
            {/* Заголовок рейтинга */}
            <div className="bg-gray-800/70 py-3 px-4 border-b border-gray-700/50">
              <h2 className="text-lg font-bold text-center text-white">Рейтинг игроков</h2>
            </div>
                ...
                <div className="h-full flex flex-col">
                  ...
                  <div className="flex-1 overflow-y-auto px-2 py-2">
                    {leaderboard.map((player) => (
                      <motion.div
                        key={player.userId}
                        className={`${getPositionBackgroundColor(player.position)} ${player.position <= 3 ? 'border-l-4 border-yellow-500/80' : ''} mb-2 rounded-lg overflow-hidden shadow-md backdrop-blur-sm`}
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
